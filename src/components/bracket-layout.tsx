      ...
      <div className="w-full overflow-x-auto pb-6 scrollbar-thin scrollbar-thumb-slate-800 scrollbar-track-transparent">
        <div className="flex flex-row items-center justify-center gap-6 min-w-[1300px] px-8 py-4">
          ...
          <div className="flex flex-row gap-6 items-center">
            {/* R32 Left */}
            <div className="flex flex-col justify-between h-[800px] py-2">
              {LEFT_R32_IDS.map((id) => (
                <MatchCard
                  key={id}
                  {...getMatch(id)}
            ...
            {/* R16 Left */}
            <div className="flex flex-col justify-around h-[800px] py-10">
              {LEFT_R16_IDS.map((id) => (
                <MatchCard
                  key={id}
                  {...getMatch(id)}
            ...
            {/* QF Left */}
            <div className="flex flex-col justify-around h-[800px] py-20">
              {LEFT_QF_IDS.map((id) => (
                <MatchCard
                  key={id}
                  {...getMatch(id)}
          ...
          <div className="flex flex-col items-center justify-center w-[260px] h-[800px] gap-8">
